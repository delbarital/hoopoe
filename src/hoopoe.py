...
def df_enrich(df, source_data_name, source_data_type, target_data_type):
    ...
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_total_area_rank':
        df = us_states.us_state_total_area_rank(df, target_data_type)
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_total_area_km':
        df = us_states.us_state_total_area(df, target_data_type)
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_land_area_rank':
        df = us_states.us_state_land_area_rank(df, target_data_type)
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_land_area_km':
        df = us_states.us_state_land_area(df, target_data_type)
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_water_area_rank':
        df = us_states.us_state_water_area_rank(df, target_data_type)
    if source_data_name == 'us_state_name_full' and target_data_type == 'us_state_water_area_km':
        df = us_states.us_state_water_area(df, target_data_type)
